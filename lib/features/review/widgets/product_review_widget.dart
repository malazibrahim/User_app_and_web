...
import 'package:atbrakitchen_multivendor/features/product/domain/models/review_body_model.dart';
...
import 'package:atbrakitchen_multivendor/common/widgets/my_text_field_widget.dart';
          ...
          itemBuilder: (context, index) {
            return Container(
              ...
              child: Column(children: [
                ...
                Row(
                  children: [
                    (widget.orderDetailsList[index].foodDetails!.imageFullUrl != null && widget.orderDetailsList[index].foodDetails!.imageFullUrl!.isNotEmpty) ?
                    ClipRRect(
                      borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                      child: CustomImageWidget(
                        height: 70, width: 85, fit: BoxFit.cover,
                        image: '${widget.orderDetailsList[index].foodDetails!.imageFullUrl}',
                        isFood: true,
                      ),
                    ) : const SizedBox(),
