...
import 'package:atbrakitchen_multivendor/features/home/widgets/restaurants_card_widget.dart';
...
class NewOnatbrakitchenViewWidget extends StatelessWidget {
  final bool isLatest;
  const NewOnatbrakitchenViewWidget({super.key, required this.isLatest});
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                ) : const RestaurantsCardShimmer(isNewOnatbrakitchen: false),
             ],
            ),
