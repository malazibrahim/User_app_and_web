...
import 'package:atbrakitchen_multivendor/common/widgets/custom_ink_well_widget.dart';
import 'package:atbrakitchen_multivendor/features/favourite/controllers/favourite_controller.dart';
import 'package:atbrakitchen_multivendor/features/home/widgets/icon_with_text_row_widget.dart';
import 'package:atbrakitchen_multivendor/features/home/widgets/overflow_container_widget.dart';
import 'package:atbrakitchen_multivendor/features/restaurant/controllers/restaurant_controller.dart';
import 'package:atbrakitchen_multivendor/features/splash/controllers/theme_controller.dart';
...
import 'package:atbrakitchen_multivendor/common/widgets/not_available_widget.dart';
...
class RestaurantsCardWidget extends StatelessWidget {
  ...
  final bool? isNewOnatbrakitchen;
  const RestaurantsCardWidget({super.key, this.isNewOnatbrakitchen, required this.restaurant});
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        Container(
          width: isNewOnatbrakitchen! ? ResponsiveHelper.isMobile(context) ? 350 : 380  : ResponsiveHelper.isMobile(context) ? 330: 355,
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Row(children: [
                      Stack(
                        children: [
                          Container(
                            padding: EdgeInsets.all(isNewOnatbrakitchen! ? 2 : 3),
                            height: isNewOnatbrakitchen! ? 95 : 65, width: isNewOnatbrakitchen! ? 95 : 65,
                            decoration:  BoxDecoration(
                            ...
                            child: ClipRRect(
                              ...
                              child:  CustomImageWidget(
                                image: '${restaurant.logoFullUrl}',
                                    fit: BoxFit.cover, height: isNewOnatbrakitchen! ? 95 : 65, width: isNewOnatbrakitchen! ? 95 : 65,
                                isRestaurant: true,
                              ),
                            ),
                          ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: isNewOnatbrakitchen! ? Dimensions.paddingSizeSmall : Dimensions.paddingSizeExtraSmall),
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                              ...
                              isNewOnatbrakitchen! ? restaurant.freeDelivery! ? ImageWithTextRowWidget(
                              ...
                              isNewOnatbrakitchen! ? const SizedBox(width : Dimensions.paddingSizeExtraSmall) : const SizedBox(width: Dimensions.paddingSizeSmall),

                              isNewOnatbrakitchen! ? ImageWithTextRowWidget(
                              ...
                              isNewOnatbrakitchen! ? const SizedBox(width : Dimensions.paddingSizeExtraSmall) : restaurant.freeDelivery! ? const SizedBox(width: Dimensions.paddingSizeSmall) : const SizedBox(),
                  ...
                  isNewOnatbrakitchen! ? const SizedBox() : Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
...
class RestaurantsCardShimmer extends StatelessWidget {
  final bool? isNewOnatbrakitchen;
  const RestaurantsCardShimmer({super.key, this.isNewOnatbrakitchen});

  @override
  Widget build(BuildContext context) {
    return SizedBox(
      height: isNewOnatbrakitchen! ? 300 : ResponsiveHelper.isDesktop(context) ? 160 : 130,
      child: isNewOnatbrakitchen! ? GridView.builder(
