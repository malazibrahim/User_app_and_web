...
class WebNewOnatbrakitchenViewWidget extends StatelessWidget {
  final bool isLatest;
  const WebNewOnatbrakitchenViewWidget({super.key, required this.isLatest});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ) : const RestaurantsCardShimmer(isNewOnatbrakitchen: true),
            ],
          ),
